...
int main(void) {
  ...
  float direction = 1;
    ...
    UART3_Control_Init();
    UARTSEQ_Init(&huart3, HAL_GetTick);
  #endif
  ...
  while(1) {
    HAL_Delay(DELAY_IN_MAIN_LOOP); //delay in ms
      ...
      UARTSEQ_GetCommand(&lcmd, &rcmd);
      // Convert differential to steer/speed
      int spd  = (int)((lcmd + rcmd) / 2);
      int str  = (int)(rcmd - lcmd);
      cmd1 = CLAMP(str, -1000, 1000);
      cmd2 = CLAMP(spd, -1000, 1000);
      timeout = 0;
    #endif
